...
<div class="container">
  ...
  <div class="row">
	<div class="col s12 form">
		...
		<a href="<?php echo URLestilo ?>/dashboard/configurar/cliente/atualizar-usuario-cliente/<?php echo $nomecliente[0]['id_cliente']; ?>" 
  			class="btn-floating btn-small waves-effect teal accent-4 " style="padding: 0 0px!important;">
  			<i class="material-icons" >arrow_back</i></a>


		<h4>Dados do usuário da empresa: <?php echo $nomecliente[0]['nome_cliente']; ?></h4>
		...
		<form role="form" action="/<?php echo pastaPrincipal ?>/dashboard/configurar/cliente/atualizar-usuario-cliente/<?php echo $nomecliente[0]['id_cliente']; ?>/editar/<?php echo $usuarioDados[0]['id_user']; ?>" method="post">

			<div class="input-field col s12 l12">

				<div class="input-field col s12 l5">
			        <i class="material-icons prefix">assignment_turned_in</i>
		          	<input id="nomelogin" type="text" class="validate" name="user" required="" value="<?php echo $usuarioDados[0]['user'] ?>">
		          	<label for="nomelogin">Nome de login / usuário</label>
				</div>

				<div class="input-field col s12 l5">
			        <i class="material-icons prefix">email</i>
		          	<input id="email" type="email" class="validate" name="email" required="" value="<?php echo $usuarioDados[0]['email'] ?>">
