...
<div class="container">
  ...
  <div class="row">
    <div class="col s12 form">
    	...
    	<form role="form" action="/<?php echo pastaPrincipal ?>/dashboard/configurar/cliente/arquivos/<?php echo $id; ?>" method="post">
				...
				<tbody>
					  ...
					  <?php foreach ($arquivos as $value) { 
						...
						<tr>
							...
							<td>
								<a href="<?php echo URLestilo ?>/dashboard/configurar/cliente/arquivos/<?php echo $value[$i]['idtarquivo']?>/delete/<?php echo $id; ?>" onclick="return confirm('Deseja realmente excluir este arquivo?')" class="btn-floating btn-small waves-effect red accent-4 " style="padding: 0 0px!important;">
