...
<div class="container">
  ...
  <div class="row">
    <div class="col s12">
      <h1>Lead em espera de Status <strong><?php echo $status[0]['tipostatus'] ?></strong></h1>
...
<div class="container">
  ...
  <div class="row">
    <div class="col s12 form">
    	...
    	<form role="form" action="/<?php echo pastaPrincipal ?>/dashboard/lead-espera/?tempo=tempo?pesquisa=$pesquisa&page=$numero" method="get">

    		<div class="row">
				<div class="input-field col s12 l9">
					<input type="hidden" id="tempo" name="tempo" value="<?php echo $_SESSION["tempo"] ?>">
							...
							<td class="edite-form"> 
								...
								<a href="<?php echo URLestilo ?>/dashboard/editar/<?php echo $value[$i]['idlead']?>" 
					  			...
					  			<i class="material-icons" >edit</i></a>
					  				...
					  				<a href="<?php echo URLestilo ?>/dashboard/lead-espera/<?php echo $value[$i]['idlead']?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn-floating btn-small waves-effect red accent-4 " style="padding: 0 0px!important;">
